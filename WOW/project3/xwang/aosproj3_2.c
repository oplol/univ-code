...
// vector Function
// --------------
// This function will return the maximum vector clock value of 
// send and recv event.
// 
//
// Return Value
...
// send the information to slaves and recv the vector clock from the slaves
...
// exec_count		int					loop counter for print exec vector clock
// send_count		int					loop counter for print send vector clock
// recv_count		int					loop counter for print recv vector clock
// end_count		int					loop counter for print end vector clock
// read_track		char*				some block of string delimited by some delimiter
// strline			char[]				string to store each line of the input file
// vector_time		int[]				vector clock array
//
//************************************************************************
...
// calculate the vector clock of each process. Then they will send the vector clock
...
// vector_clock		int[]				vector clock to maximum the clock
// i				int					loop counter for vector clock initialization
// j				int					loop counter for comparing the vector clock
//
//************************************************************************
...
// main Function
// -------------
// This function uses the master and slaves algorithm to simulate the vector
// clock, and reads in a set of simulation parameters and then print
// the vector clocks associated with each event.
// 
//
// Return Value
// ------------
