...
//Due:      Apr  5, 2011
//Purpose:  Create two binary search trees and invoke some of the class
//          functions
//
//Input:    The trees using file input from lab11file1.dat and lab11file2.dat.
//
//Output:   The output will be printed directly to the screen
//          then redirect the screen output to the file "lab11report.txt"
//          then create a makefile.
//
//Program outline:
//           Open "lab11file1.dat" file for input1; test for successful open
//           Open "lab11file2.dat" file for input2; test for successful open
...
//           Print all the output directly to the screen, then redirect to the file "lab11report.txt"
//           Close both files
...
void ReadAndWriteFiles(ifstream&, bSearchTreeType<elemType>&);

int main()
{
	bSearchTreeType<int> tree1, tree2;
	ifstream dataFileIn1, dataFileIn2;
	char inputFile1[30] = "lab11file1.dat";
	char inputFile2[30] = "lab11file2.dat";

	//print heading
	cout << "             OUTPUT FOR XINYI WANG LAB11	SPRING 2011" << endl;
...
template <class elemType>
void ReadAndWriteFiles(ifstream& dataFileIn, bSearchTreeType<elemType>& tree)
{
	int num;
	dataFileIn >> num;
