...
//Due:      Apr 19, 2011
//Purpose:  Modify the AVL tree in the previous lab to include
...
//           Print all the output directly to the screen, then redirect to the file "lab13report.txt"
//           Close both files
...
int main()
{
	...
	//print heading
	cout << "             OUTPUT FOR XINYI WANG LAB13	SPRING 2011" << endl;
...
void ReadAndWriteFiles(ifstream& dataFileIn, AVLTreeType<elemT>& tree)
{
	...
	//the nodes hierarchially
	cout << "   5) The nodes hierarchially: " << endl;
	tree.rnl_inorderTraversal(rnl_print);
	cout << endl;
}


//Purpose:        Print the integer value
//Pre-condition:  The integer value passed in
//Post-condition: The output is printed to the screen according to data passed in
template <class elemT>
void print(elemT& x)
{
	cout << x << " ";
...
//Purpose:        Print the integer value hierarchially
//Pre-condition:  The integer value and level passed in
//Post-condition: The output is printed to the screen according to data passed in
template <class elemT>
void rnl_print(elemT& n, int m)
{
